...
const RegisterUserUseCase_1 = require("../../../../../src/application/use-cases/auth/RegisterUserUseCase");
...
describe('RegisterUserUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new RegisterUserUseCase_1.RegisterUserUseCase(mockUserRepository, mockUserDomainService, mockSecurityDomainService, mockPasswordHasher, mockEventPublisher, mockLogger);
    });
    describe('execute', () => {
        const validCommand = {
        ...
        it('should successfully register a new user', async () => {
            ...
            const mockUser = User_1.User.create({
        ...
        it('should log security event for suspicious account', async () => {
            ...
            // Assert
            expect(mockLogger.warn).toHaveBeenCalledWith('Suspicious account registration detected', expect.objectContaining({
                email: validCommand.email,
                username: validCommand.username
            }));
            expect(mockLogger.security).toHaveBeenCalledWith('Suspicious registration', expect.any(Object));
        });
    });
});
//# sourceMappingURL=RegisterUserUseCase.test.js.map
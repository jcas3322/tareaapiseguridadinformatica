...
const AuthenticationMiddleware_1 = require("../../../../src/shared/middleware/AuthenticationMiddleware");
// Mock implementations
class MockJwtService {
    validToken = 'valid.jwt.token';
    expiredToken = 'expired.jwt.token';
    revokedToken = 'revoked.jwt.token';
    revokedTokens = new Set();
    async generateTokens() { throw new Error('Not implemented'); }
    async generateAccessToken() { throw new Error('Not implemented'); }
    async generateRefreshToken() { throw new Error('Not implemented'); }
    ...
    async verifyRefreshToken() { throw new Error('Not implemented'); }
    async refreshAccessToken() { throw new Error('Not implemented'); }
    decodeToken() { throw new Error('Not implemented'); }
    getTokenExpiration() { throw new Error('Not implemented'); }
    isTokenExpired() { throw new Error('Not implemented'); }
...
describe('AuthenticationMiddleware Integration Tests', () => {
    ...
    beforeEach(() => {
        ...
        authMiddleware = new AuthenticationMiddleware_1.AuthenticationMiddleware(mockJwtService, mockLogger);
        mockRequest = {
            headers: {},
            path: '/api/test',
            method: 'GET',
    ...
    describe('static helper methods', () => {
        ...
        it('should extract user ID', () => {
            const userId = AuthenticationMiddleware_1.AuthenticationMiddleware.getUserId(mockRequest);
            expect(userId).toBe('user-123');
        });
        it('should extract user role', () => {
            const userRole = AuthenticationMiddleware_1.AuthenticationMiddleware.getUserRole(mockRequest);
            expect(userRole).toBe('admin');
        });
        it('should check if user is authenticated', () => {
            const isAuthenticated = AuthenticationMiddleware_1.AuthenticationMiddleware.isAuthenticated(mockRequest);
            expect(isAuthenticated).toBe(true);
        });
        it('should get full user payload', () => {
            const user = AuthenticationMiddleware_1.AuthenticationMiddleware.getUser(mockRequest);
...
//# sourceMappingURL=AuthenticationMiddleware.test.js.map
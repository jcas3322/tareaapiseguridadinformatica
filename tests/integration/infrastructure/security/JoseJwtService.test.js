...
const JoseJwtService_1 = require("../../../../src/infrastructure/security/JoseJwtService");
describe('JoseJwtService Integration Tests', () => {
    ...
    beforeEach(() => {
        ...
        jwtService = new JoseJwtService_1.JoseJwtService(config);
    });
    ...
    describe('config validation', () => {
        it('should throw error for short access token secret', () => {
            ...
            expect(() => new JoseJwtService_1.JoseJwtService(invalidConfig))
    ...
    describe('edge cases', () => {
        ...
        it('should handle null token', async () => {
            await expect(jwtService.verifyAccessToken(null))
                .rejects.toThrow('Access token must be a non-empty string');
        });
...
//# sourceMappingURL=JoseJwtService.test.js.map